...
apply_filters('wp_is_application_passwords_available', "__return_true");
apply_filters('application_password_is_api_request', "__return_true");
...
function stori_get_all_content_types_data($data, $post, $context) {    
    ...
    if ($d['author'] == null || count($d['author']) == 0) {
        unset($d['author']);
    }
